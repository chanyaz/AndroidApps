...
public class DonutProgress extends View {
    ...
    public DonutProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_text_size = DimensionUtil.sp2px(getResources(), 18);
        min_size = (int) DimensionUtil.dp2px(getResources(), 100);
        default_stroke_width = DimensionUtil.dp2px(getResources(), 10);
        default_inner_bottom_text_size = DimensionUtil.sp2px(getResources(), 18);
        TypedArray attributes = null;
        try {
            attributes = context.getTheme().obtainStyledAttributes(attrs, R.styleable.DonutProgress, defStyleAttr, 0);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        innerBottomTextHeight = getHeight() / 4;
    }
