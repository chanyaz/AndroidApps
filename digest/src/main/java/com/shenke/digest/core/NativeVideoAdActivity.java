...
public class NativeVideoAdActivity extends BaseActivity {
	...
	private void setupNativeVideoAd() {
		...
		final VideoInfoViewBuilder videoInfoViewBuilder =
				VideoAdManager.getInstance(NativeVideoAdActivity.this).getVideoInfoViewBuilder(NativeVideoAdActivity.this)
		...
		mBtnShowNativeVideoAd.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// 获取原生视频控件
				View nativeVideoAdView = VideoAdManager.getInstance(NativeVideoAdActivity.this)
						.getNativeVideoAdView(NativeVideoAdActivity.this, videoAdSettings, new VideoAdListener() {
							@Override
							...
							public void onPlayInterrupted() {
								...
								Toast.makeText(NativeVideoAdActivity.this, "播放视频被中断",Toast.LENGTH_LONG).show();
								// 中断播放时恢复展示原生视频广告按钮
							...
							public void onPlayFailed(int errorCode) {
								...
								case ErrorCode.NON_NETWORK:
									//showShortToast("网络异常");
									Toast.makeText(NativeVideoAdActivity.this, "网络异常",Toast.LENGTH_LONG).show();
									break;
								case ErrorCode.NON_AD:
									//showShortToast("原生视频暂无广告");
									Toast.makeText(NativeVideoAdActivity.this, "原生视频暂无广告",Toast.LENGTH_LONG).show();
									break;
								case ErrorCode.RESOURCE_NOT_READY:
									//showShortToast("原生视频资源还没准备好");
									Toast.makeText(NativeVideoAdActivity.this, "原生视频资源还没准备好",Toast.LENGTH_LONG).show();
									break;
								case ErrorCode.SHOW_INTERVAL_LIMITED:
									//showShortToast("请勿频繁展示");
									Toast.makeText(NativeVideoAdActivity.this, "请勿频繁展示",Toast.LENGTH_LONG).show();
									break;
								case ErrorCode.WIDGET_NOT_IN_VISIBILITY_STATE:
									//showShortToast("原生视频控件处在不可见状态");
									Toast.makeText(NativeVideoAdActivity.this, "原生视频控件处在不可见状态",Toast.LENGTH_LONG).show();
									break;
								default:
									logError("请稍后再试");
									break;
							...
							public void onPlayCompleted() {
								Toast.makeText(NativeVideoAdActivity.this, "播放视频成功",Toast.LENGTH_LONG).show();
								// 播放完成时恢复展示原生视频广告按钮
								showShowNativeVideoButton();
								// 隐藏视频信息流视图
								hideVideoInfoLayout();
	...
	protected void onStart() {
		super.onStart();
		// 原生视频广告
		VideoAdManager.getInstance(NativeVideoAdActivity.this).onStart();
	}
	...
	protected void onResume() {
		super.onResume();
		// 原生视频广告
		VideoAdManager.getInstance(NativeVideoAdActivity.this).onResume();
	}
	...
	protected void onPause() {
		super.onPause();
		// 原生视频广告
		VideoAdManager.getInstance(NativeVideoAdActivity.this).onPause();
	}
	...
	protected void onStop() {
		super.onStop();
		// 原生视频广告
		VideoAdManager.getInstance(NativeVideoAdActivity.this).onStop();
	}
	...
	protected void onDestroy() {
		super.onDestroy();
		// 原生视频广告
		VideoAdManager.getInstance(NativeVideoAdActivity.this).onDestroy();
	}
