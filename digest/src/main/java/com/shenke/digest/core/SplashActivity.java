...
import com.shenke.digest.util.PermissionHelper;
...
public class SplashActivity extends BaseActivity {
    ...
    private void runApp() {
        //初始化SDK
        AdManager.getInstance(mContext).init("210ea37389f0b804", "9be64feaef4e7679", true);
        //设置开屏
        setupSplashAd();
    }
    ...
    private void setupSplashAd() {
        ...
        // 设置跳转的窗口类
        splashViewSettings.setTargetClass(NewsListActivity.class);
        // 设置开屏的容器
