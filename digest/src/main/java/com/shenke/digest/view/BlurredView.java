...
import com.shenke.digest.util.BitmapUtil;
import com.shenke.digest.util.BlurBitmapUtil;

/**
 * Created by Cloud on 2016/12/15.
 */
...
public class BlurredView extends RelativeLayout {
    ...
    private void initView(Context context) {
        mContext = context;
        LayoutInflater.from(context).inflate(R.layout.framelayout_blurredview, this);
    ...
    public void setImage(Drawable drawable) {
        mOriginImg.setImageDrawable(drawable);
       // mBlurredImg.setImageDrawable(drawable);
    }
