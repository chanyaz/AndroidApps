...
public class SelectableTextHelper {
    ...
    private class OperateWindow {
        ...
        public OperateWindow(final Context context) {
             ...
             * Dictionary
             */
            contentView.findViewById(R.id.tv_dictionary).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ClipboardManager clip = (ClipboardManager) mContext.getSystemService(Context.CLIPBOARD_SERVICE);
                    clip.setPrimaryClip(
                    ...
                    intent.putExtra("TranslateData", clip.getPrimaryClip().getItemAt(0).coerceToText(mContext).toString());
